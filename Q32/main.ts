...
let current_users = ["Sandal Ghani", "Umaima Arif", "Kinza Asif", "Ghazala Yasmeen", "Anoosha Ghani"]

//• Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let new_users = ["Muhammad Balaj", "Umair Ahmed", "Muhammad Arham", "Muhammad Ghayas", "Abdul Ghani"]
